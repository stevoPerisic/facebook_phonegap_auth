...
function onOnline() {
 	alert('We are online!');
	  ...
	  $('#auth-loginlink').bind('click', function(){
		...
		var thisurl = 'http://www.facebook.com/dialog/oauth/?client_id=519491361401353&redirect_uri=https://www.facebook.com/connect/login_success.html&response_type=token&display=touch';
